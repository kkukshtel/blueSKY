<?php
	...
	**/
	...
	function display_latest_tweets(
		...
		// Function parameters.
		$twitter_user_id,
		$cache_file          = './tweets_test.txt',  // Change this to the path of your cache file. (Default : ./tweets.txt)
		...
		$date_format         = 'H i m d Y',    // Date formatting. (http://php.net/manual/en/function.date.php)
		$twitter_style_dates = false){           // Twitter style days. [about an hour ago] (Default : true)
			
		// Twitter keys (You'll need to visit https://dev.twitter.com and register to get these.
		$consumerkey         = "8l5qPszbb769WvICoyi7tOWv6";
		$consumersecret      = "JCur4ATu7JRXy1WiHZ2fzxpX3IllOG4xi6ark3FQ2L2HApzOvi";
		$accesstoken         = "18124658-1k3YltA4bRNXu8vf2WF0o5OcIfAbi2Jbkb5yPoYdD";
		$accesstokensecret   = "rXuF4yK51GPKnPxyCyt2uqY3rT0p2J2oWWIEydTpuVXX4";
	...
	display_latest_tweets('kkukshtel');
?>
